...
# build/X86/gem5.opt -d "output/fs_lmbench_dram" configs/example/gem5_library/x86-cxl-run.py --is_asic True --test_cmd lmbench_dram.sh --num_cpu 1 --cpu_type TIMING
